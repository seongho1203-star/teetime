...
export const profiles = [
    { id: uid(1), name: '신성호', avatar_url: null, role: 'admin',   handicap: 12.5, phone: '010-1234-5678', memo: '', created_at: iso(-120) },
    { id: uid(2), name: '이관교', avatar_url: null, role: 'member',  handicap: 18,   phone: null, memo: '', created_at: iso(-110) },
    { id: uid(3), name: '김지명', avatar_url: null, role: 'member',  handicap: 9.2,  phone: null, memo: '', created_at: iso(-100) },
    { id: uid(4), name: '박승수', avatar_url: null, role: 'member',  handicap: 21,   phone: null, memo: '', created_at: iso(-90) },
...
export const rounds = [
    { id: 'r1', title: '8월 정기 라운드', course: '무등산CC', lat: null, lon: null,
    ...
    { id: 'r2', title: '', course: '함평엘리체CC', lat: null, lon: null,
