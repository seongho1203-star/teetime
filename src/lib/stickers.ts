 ...
 * 묶음 목록.
 *
 * 열한 묶음이다 — 움직이는 것 열여덟(영상에서 잘랐다. 배경이 투명한 장면만
 * 골랐다), **골프공 움짤 스물 · 소년 움짤 마흔넷 · 펭귄 움짤 서른**
 * (검은 바탕 영상 네 편에서 잘랐다 — 아래 참고), 골프공(앱 아이콘과 같은
 * 캐릭터) 스물일곱, 골퍼 스물넷, 골프친구 스물넷, 펭귄골프 스물둘,
 * 펭귄 스물여덟, 고양이 스물넷, 이모지 열여덟.
 * **차례는 원본에 나온 차례 그대로다.**
 *
...
export const STICKER_GROUPS: StickerGroup[] = [
    ...
    /* 아래 셋은 **검은 바탕에 격자로 깔린 영상 네 편**에서 잘랐다.
       그전 것들(체커 바탕)과 달리 바탕이 순수한 검정이라, **밝기로 딴 것과
       rembg로 딴 것을 겹쳐** 알파를 만들었다 — 밝기는 하트·글자·반짝임까지
       픽셀 단위로 정확하고, rembg는 밝기로는 바탕과 구별이 안 되는
       **어두운 것**(선글라스·모자 그늘·머리카락)을 맡는다.
       10fps · 열두 장 · `loop=3`이고, 한 장이 120~250KB다.

       **`⛳ 골프공`·`💙 펭귄`과 같은 캐릭터지만 묶음을 따로 두었다** —
       그쪽은 정지 그림 시트이고 이건 움직이는 판이라 서로 다른 세트다.
       한 탭에 섞으면 같은 말이 두 번씩 들어가 쉰 장 넘는 탭이 된다. */
    g('mvgolf', '🏌️', '골프공 움짤',
      a('mvg11', '까꿍day'), a('mvg12', '하트'), a('mvg13', 'Good!'),
      a('mvg14', '한잔해요!'), a('mvg15', '화이팅!'), a('mvg21', '같이 쳐요'),
      a('mvg22', '스윙'), a('mvg23', '카트'), a('mvg24', '뭐해요?'),
      a('mvg25', '요리 중'), a('mvg31', '손가락 하트'), a('mvg32', '뒹굴뒹굴'),
      a('mvg33', '쉬는 중'), a('mvg34', '좋아 좋아'), a('mvg35', '달려!'),
      a('mvg41', '축하해!'), a('mvg42', '감사합니다'), a('mvg43', '홀인원!'),
      a('mvg44', '엉엉'), a('mvg45', '또봐요~')),

    /* **영상 두 편이 같은 캐릭터라 한 묶음으로 합쳤다**(모자 쓴 소년).
       세트로 가르는 규칙을 어기는 것 같지만, 탭 이름이 둘 다 `소년`이 되어
       어느 쪽에 무엇이 있는지 매번 헷갈리는 쪽이 더 나쁘다. */
    g('mvkid', '👦', '소년 움짤',
      a('mvk11', '어쩌라고'), a('mvk12', '분해!'), a('mvk13', '흥!'),
      a('mvk14', 'ㅋㅋㅋㅋ'), a('mvk15', '헐~'), a('mvk21', '하트'),
      a('mvk22', '췟!'), a('mvk23', '깜짝!'), a('mvk24', '쿨쿨'),
      a('mvk25', '좋아!'), a('mvk31', '부끄부끄'), a('mvk32', '으앙~'),
      a('mvk33', '음…?'), a('mvk34', '가즈아!'), a('mvk35', '짜증나!'),
      a('mvk41', '헉!'), a('mvk42', '쪽~'), a('mvk43', '냠냠'),
      a('mvk44', '힝…'), a('mvk45', '잘가!'),
      a('mvn11', '좋아요'), a('mvn12', '하하하'), a('mvn13', '하트 뿅뿅'),
      a('mvn14', '아자!'), a('mvn15', '뾰로통'), a('mvn16', '불타오른다'),
      a('mvn21', '엉엉'), a('mvn22', '쭈뼛'), a('mvn23', '깜짝!'),
      a('mvn24', '안녕~'), a('mvn25', '시무룩'), a('mvn26', '부끄'),
      a('mvn31', '쿨쿨'), a('mvn32', '축 처짐'), a('mvn33', '만세!'),
      a('mvn34', '하트 드림'), a('mvn35', '심심해'), a('mvn36', '부탁해'),
      a('mvn41', '멋져'), a('mvn42', '커피 한 잔'), a('mvn43', '엎드려 자기'),
      a('mvn44', '두근두근'), a('mvn45', '윙크'), a('mvn46', '브이')),
