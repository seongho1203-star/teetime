 ...
 * 묶음 목록.
 *
 * 열 묶음이다 — 움직이는 것 열여덟(영상에서 잘랐다. 배경이 투명한 장면만
 * 골랐다), **소년 움짤 마흔넷 · 펭귄 움짤 서른**
 ...
 *
 * (같은 영상 네 편에서 잘라 낸 `🏌️ 골프공 움짤` 스무 장이 잠깐 있었는데
 * **사용자가 보고 지우라고 했다** — `골프공 움짤은 별로네. 삭제해줘`.
 * 그림 파일도 함께 지웠으니 되살리지 말 것.)
 */
export const STICKER_GROUPS: StickerGroup[] = [
    ...
    /* 아래 둘은 **검은 바탕에 격자로 깔린 영상 네 편**에서 잘랐다.
