    ...
    return (
        <div className="page help">
            ...
            <Part icon="⛳" title="라운드 — 신청하고 기다리기"
                ...
                <p className="help-tip">
                    만날 곳이나 물어볼 것은 그 라운드 <b>맨 아래 댓글</b>에 남기세요.
                    대화방에 쓰면 묻힙니다.
                </p>
            </Part>
            ...
            {/* **홈 화면 추가 안내는 여기 넣지 않는다.** 앱으로 설치하면
                없어지는 이야기라, 그때 설명서가 거짓말이 된다. */}
            <Part icon="🔔" title="알림 — 두 가지로 나뉩니다"
                  lead="내 정보에서 켜고 끕니다. 안 켜시면 모집이 열려도 모르고 지나갑니다.">
                <ul className="help-list">
                    <li><b>전체 알림</b> — 새 모집 · 새 투표 · 새 공지 · 내 정산.
                        하루 몇 번뿐이라 <b>켜 두시길 권합니다.</b></li>
                    <li><b>대화 알림</b> — 대화방에 글이 올라올 때마다.
                        종일 울려서 <b>이것만 따로 끌 수 있습니다.</b></li>
                </ul>
                <p className="help-tip">
                    대화 알림을 꺼도 <b>누가 나를 @부르거나 내 글에 답장하면</b>
                    {' '}그건 옵니다. 시끄러워서 껐는데 정작 나를 찾는 말을
                    놓치는 일은 없습니다.
                </p>
            </Part>
            ...
            <Part icon="🙋" title="이건 알아 두세요">
                <ul className="help-list">
                    <li><b>차량번호</b>는 <b>골프장에 차를 미리 등록</b>할 때
                        필요해서 받습니다. <b>내 정보</b>에서 언제든 고치실 수 있습니다.</li>
